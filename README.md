...
## remote_rosbag_record (noetic) - 0.0.4-1

The packages in the `remote_rosbag_record` repository were released into the `noetic` distro by running `/usr/bin/bloom-release remote_rosbag_record --rosdistro noetic` on `Sat, 26 Sep 2020 00:31:52 -0000`
...
## remote_rosbag_record (noetic) - 0.0.3-1
